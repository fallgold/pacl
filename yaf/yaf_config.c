...
yaf_config_t * yaf_config_instance(yaf_config_t *this_ptr, zval *arg1, zval *arg2 TSRMLS_DC) {
	...
	if (Z_TYPE_P(arg1) == IS_ARRAY) {
		yaf_trigger_error(YAF_ERR_TYPE_ERROR TSRMLS_CC, "Expects a string as parameter");
		return NULL;
		zval *readonly;
...
*/
STU_MINIT_FUNCTION(config) {
	zend_class_entry ce;

	INIT_CLASS_ENTRY(ce, "Pacl_Yaf_Config_Abstract", yaf_config_methods);
